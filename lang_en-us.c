...
CSTRING Flavors[] = { "spicy","sour","sweet","dry","bitter" };

CSTRING Statnames[] = { "Attack", "Defense", "Speed", "Special Attack", "Special Defense" };
CSTRING BattleStatNames[] = { "attack", "defense", "speed", "Sp.Atk", "Sp.Def", "accuracy", "evasiveness" };

CSTRING natures[0x19] =
{
	"Hardy",	"Lonely",	"Brave",
...
CSTRING strHelpExit = "Exit";
CSTRING strHelpCancel = "Cancel";

CSTRING strGotAMonster = "%s recieved a\n%s!\1";
CSTRING strGotAnItem = "%s got %d \n%s!\7\x8\x30\1";
CSTRING strPutAwayItem = "%s put the %s\nin the %s pocket.\7\x8\x30\1";

CSTRING strTimeAndPlaceForEverything = "There's a time and place for\neverything, \x1F\1.";

CSTRING strSaveError = "%s was not\nproperly saved.";
CSTRING strWantToSave = "Would you like to save the game?\1";
CSTRING strStillWantToSave = "There is already a saved file.\nIs it okay to overwrite it?\1";
CSTRING strSaving = "SAVING…\nDON'T TURN OFF THE POWER!\1";
CSTRING strSaved = "Game saved.";

CSTRING strImportError = "Warning: it says there are "POKEMON"\nwaiting for import,\r\nbut the counter is set to zero.";
CSTRING strImportOne = "There is a "POKEMON" waiting for import.\nWould you like to import it now?\1";
CSTRING strImportMore = "There are %d "POKEMON" waiting for import.\nWould you like to import them now?\1";
CSTRING strImporting = "Importing…\1";
CSTRING strImported = "%s was imported\nto box “%s”.";
CSTRING strImportOneNot = "Would you rather not import it at all?\1";
CSTRING strImportMoreNot = "Would you rather not import them at all?\1";
CSTRING strImportWipe = "Clearing…\1";

CSTRING strHMUse = "%s used %s!";
CSTRING strHMOfferCut = "This tree looks like it can be cut down.\nWould you like to cut it?\1";
CSTRING strHMOfferSmash = "This rock appears to be breakable.\nWould you like to use %s?\1";
CSTRING strHMCouldCut = "This tree looks like it can be cut down.";
CSTRING strHMCouldSmash = "It's a rugged rock, but a "POKEMON"\nmay be able to smash it.";

//Error message for when the game detects a change in the startup credits.
CSTRING strHacked = "This game has been hacked in\n"
										"a way we can't accept.";

//Introduction part 1
CSTRING strIntroLetter[] =
{
...
//Extra prompt
CSTRING strShirtPrompt = "Select your shirt color.\1";
#endif

//Player names
CSTRING strIntroNewName = "New name";
CSTRING playernames[3][12] =
{
	{
		"Danny",
		"Joe",
...
CSTRING strMainClockDry = "The clock battery has run dry.\n"
															 "The game can be played.\r\f"
															 "However, clock-based events will\n"
															 "no longer occur.";
CSTRING strMainSaveLost = "Save game lost -_-";
CSTRING strMainMenuContinue = "Continue";
CSTRING strMainMenuNewGame = "New Game";
CSTRING strMainMenuOptions = "Options";
CSTRING strMainMenuPlayer = "Player:";
CSTRING strMainMenuPokedex = POKE"Dex:";
CSTRING strMainMenuBadges = "Badges:";
CSTRING strMainMenuTime = "Time:";
...
CSTRING strInventCancel = "Cancel             "; //yes, padded
CSTRING strInventCloseBag = "Close bag";
CSTRING strInventCantBeHeld = "The %s can't be held.";
CSTRING strInventUseTM = "Booted up a TM.\r\f%s contained %s.\r\fTeach this to a "POKEMON"?\1";
CSTRING strInventUseHM = "Booted up an HM.\r\f%s contained %s.\r\fTeach this to a "POKEMON"?\1";
//CSTRING strInventRestoredHP = "Restored %d HP";
CSTRING strItemWasUsed = "%s was used on %s.";
CSTRING strItemHasNoEffect = "It won't have any effect";
CSTRING strNoRegisteredItem = "An item in the bag can be\nregistered to SELECT for easy use.";
CSTRING strHPRestored = "%s's HP was restored\nby %d %s.";
CSTRING strHPRestoredPoints = "point"; //this is pluralized into strHPRestored.
CSTRING strPPIncreased = "%s's PP increased.";
CSTRING strLevelElevated = "%s was elevated to\nLv. %d";
CSTRING strLevelEvolved = "%s evolved into\n%s.";
CSTRING strNoEffect = "It won't have any effect.";
...
//Status screen stuff
CSTRING strStatusNature = "%s nature.";
CSTRING strStatusMetInATrade = "Met in a trade.";
CSTRING strStatusFatedAt = "Met in a fateful encounter when at \x80\x1C %d.";
CSTRING strStatusHatchedAt = "Hatched: %s at \x80\x1C 5.";
CSTRING strStatusMetAt = "Met in %s at \x80\x1C %d.\n";
CSTRING strStatusExpToNext = "%8ld / %8ld to next";
CSTRING strStatusHatchTimes[] =
{
	// >40
	"It looks like this\n"
	"egg will take a\n"
...
//Shop system
CSTRING strShopHiThere = "Hi there!\n"
															"May I help you?\1";
CSTRING strShopNotEnoughMoney = "You don't have enough money.";
CSTRING strShopCertainly = "%s? Certainly\n"
																"How many would you like?\1";
CSTRING strShopConfirm = "%s, and you want %d.\n"
															"That'll be $%d. Okay?\1";
CSTRING strShopThankYou = "Here you are.\n"
															 "Thank you.";
CSTRING strShopComeAgain = "Please come again.";
CSTRING strShopAnythingElse = "Is there anything else I can do?\1";
CSTRING strShopMoney = "Money";
CSTRING strShopBack = "Back";
CSTRING strShopBack2 = "Back                    "; //yes, padded.

//Variable strings
CSTRING strStringVarDaughter = "daughter";
CSTRING strStringVarSon = "son";
CSTRING strStringVarHis = "his";
CSTRING strStringVarHer = "her";
CSTRING strStringVarGirl = "girl";
CSTRING strStringVarGuy = "guy";
CSTRING strStringVarChick = "chick";
CSTRING strStringVarDude = "dude";
CSTRING strStringVarBill = BILLNAME;
CSTRING strStringVarSomeone = "Someone";

//Trainer Card items
CSTRING strTrainerCardIDNo = "IDNo.%d";
CSTRING strTrainerCardName = "Name: %s";
CSTRING strTrainerCardMoney = "Money";
CSTRING strTrainerCardPokedex = POKE"Dex";
CSTRING strTrainerCardTime = "Time";
CSTRING BadgeFlavors[] =
{
	//Demo
...
//PokéDex items
CSTRING strPokedexNames[] = { "National", "Regional", "Filtered", };
CSTRING strPokedexSortings[] = { "ID", "Name", };
CSTRING strPokedexColors[] = { "---", "Red", "Blue", "Yellow", "Green", "Black", "Brown", "Purple", "Gray", "White", "Pink", };
CSTRING strPokedexGenderRatio = "Gender ratio: ";
CSTRING strPokedexAlwaysMale = "always male\n";
CSTRING strPokedexAlwaysFemale = "always female\n";
CSTRING strPokedexChanceOfFemale = "%d%% chance of female\n";
CSTRING strPokedexEvolvesLevel = "Evolves to %s at level %d.\n";
CSTRING strPokedexEvolvesHappy = "Evolves to %s when happy enough.\n";

//Descriptions of the start menu items
CSTRING StartMenuHelpStrings[] =
{
...
CSTRING strSafariStatBalls = "Balls %3d";

CSTRING strPartyCantLearnTM = "%s and %s\nare not compatible.\r\f%s can't be learned.";
CSTRING strPartySwitchedItems = "Switched the %s\nwith the held %s.";
CSTRING strPartyGaveItem = "%s was given the\n%s to hold.";
CSTRING strPartyTookItem = "Recieved the %s\nfrom %s.";
CSTRING strPartyNoItem = "%s isn't holding\nanything.";

CSTRING strStatusHeaders[] = { POKEMONU" INFO", POKEMONU" SKILLS", "KNOWN MOVES" };
CSTRING strStatusAble = "ABLE";
CSTRING strStatusNotAble = "NOT ABLE";

//Box manager strings
CSTRING strBoxThatsYourLast = "That's your last "POKEMON"!";
CSTRING strBoxYourHoldingOne = "You're holding a "POKEMON"!";
CSTRING strBoxContinueBoxOps = "Continue box operations?";
CSTRING strBoxFooIsSelected = "%s is selected.";
CSTRING strBoxPartyFull = "Your party's full!";
CSTRING strBoxIsFull = "That box is full!";
CSTRING strBoxWhatToDo = "What do you want to do?";
CSTRING strBoxJump = "Jump to which box?";
CSTRING strBoxPickTheme = "Please pick a theme.";
CSTRING strBoxPickWallpaper = "Pick the wallpaper.";

//Battle system strings
CSTRING strBattleFight = "Fight";
CSTRING strBattleBag = "Bag";
CSTRING strBattlePokemon = POKEMON;
CSTRING strBattleRun = "Run";
CSTRING strBattleFooWantsToFight = "%s %s wants\nto fight!";
CSTRING strBattleFooSentOutBar = "%s %s sent out\n%s!\1";
CSTRING strBattleIChooseYou = "%s! I choose you!\1";
CSTRING strBattleFooAppeared = "%s appeared!";
CSTRING strBattleNoEnergyToFight = "%s has no energy left to battle!";
CSTRING strBattleAlreadyThere = "%s is already in battle!";
CSTRING strBattleAlreadySelected = "%s has already been selected.";
CSTRING strBattleCantSwitch = "%s can't be switched out!";
CSTRING strBattleSwitchPrevented = "Opponent's %s prevents switching!";
CSTRING strBattleLevelUp = "%s leveled up to Lv.%d!";
CSTRING strBattleEvolved = "Congratulations! Your %s\nevolved into %s!";
CSTRING strBattleAboutToSwitch = "Your opponent is about\nto send in %s.\r\nWill you switch "POKEMON"?\1";
CSTRING strBattleOpponentSent = "Your opponent sent out\n%s!";
CSTRING strBattleOpponentWithdrew = "Your opponent withdrew %s!";
CSTRING strBattleThatsEnough = "%s, that's enough.\nCome back.";
CSTRING strBattleGo = "Go! %s!";
CSTRING strBattleOkayEnough = "Okay %s, that's enough. Come back!";
CSTRING strBattleBerryTooTasty = "For %s,\nthe %s was too %s.";
CSTRING strBattleWhatToDo = "What should\n%s do?";

CSTRING strBattleDemoNoParty = "You don't have any "POKEMON" to\ndefend yourself with!";
CSTRING strBattleDemoSendOut = "The author sent out\n%s!\1";
CSTRING strBattleDemoQuit = "KAWA: Okay kid, that's all.\nShow's over.";

//Big list of battle system strings, taken right out of the original game.
CSTRING BattleStrings[] =
{
	"%s",
	"%s gained%s\n%d EXP. Points!",
	"%s grew to\nLV. %s!",
...
CSTRING strDexRating = "The amount of progress you've made\n"
