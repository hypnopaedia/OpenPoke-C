...
int GetOption(int id)
{
	switch(id)
	{
		case OPT_TEXTSPEED: return MyPlayer.Options.textspeed;
		case OPT_BATTLESCENE: return MyPlayer.Options.battlescene;
		case OPT_BATTLESTYLE: return MyPlayer.Options.battlestyle;
		case OPT_SOUND: return MyPlayer.Options.soundmode;
		case OPT_BUTTONMODE: return MyPlayer.Options.buttonmode;
		case OPT_FRAME: return MyPlayer.Options.frame;
		case OPT_BEEPSTYLE: return MyPlayer.Options.beepstyle;
		case OPT_BATTLESKIP: return MyPlayer.Options.battleskip;
#ifdef DEBUG
		case OPT_WALKTHRU: return MyDebug.wtw;
#endif
		default: return -1;
	}
}
...
void SetOption(int id, int val)
{
	switch(id)
	{
		case OPT_TEXTSPEED: MyPlayer.Options.textspeed = val; break;
		case OPT_BATTLESCENE: MyPlayer.Options.battlescene = val; break;
		case OPT_BATTLESTYLE: MyPlayer.Options.battlestyle = val; break;
		case OPT_SOUND: MyPlayer.Options.soundmode = val; break;
		case OPT_BUTTONMODE: MyPlayer.Options.buttonmode = val; break;
		case OPT_FRAME: MyPlayer.Options.frame = val; break;
		case OPT_BEEPSTYLE: MyPlayer.Options.beepstyle = val; break;
		case OPT_BATTLESKIP: MyPlayer.Options.battleskip = val; break;
#ifdef DEBUG
		case OPT_WALKTHRU: MyDebug.wtw = val; break;
#endif
		default: break;
	}
}
